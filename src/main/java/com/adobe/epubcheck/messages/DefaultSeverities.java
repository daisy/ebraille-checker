...
class DefaultSeverities implements Severities
{
  ...
  private void initialize()
  {
    ...
    severities.put(MessageId.EBR_003, Severity.ERROR);
    severities.put(MessageId.EBR_004, Severity.ERROR);
    severities.put(MessageId.EBR_005, Severity.ERROR);
    severities.put(MessageId.EBR_006, Severity.ERROR);
    severities.put(MessageId.EBR_007, Severity.ERROR);
    severities.put(MessageId.EBR_008, Severity.ERROR);
    severities.put(MessageId.EBR_009, Severity.ERROR);
    severities.put(MessageId.EBR_009, Severity.ERROR);
    severities.put(MessageId.EBR_010, Severity.ERROR);
    severities.put(MessageId.EBR_011, Severity.WARNING);
    severities.put(MessageId.EBR_012, Severity.ERROR);
    severities.put(MessageId.EBR_013, Severity.WARNING);
    severities.put(MessageId.EBR_014, Severity.ERROR);
    severities.put(MessageId.EBR_015, Severity.ERROR);
    severities.put(MessageId.EBR_016, Severity.ERROR);
    severities.put(MessageId.EBR_017, Severity.ERROR);
    severities.put(MessageId.EBR_018, Severity.ERROR);
    severities.put(MessageId.EBR_019, Severity.ERROR);
    severities.put(MessageId.EBR_020, Severity.ERROR);
    severities.put(MessageId.EBR_021, Severity.ERROR);
    severities.put(MessageId.EBR_022, Severity.ERROR);
    severities.put(MessageId.EBR_030, Severity.WARNING);
    severities.put(MessageId.EBR_040, Severity.ERROR);
    severities.put(MessageId.EBR_041, Severity.ERROR);
    severities.put(MessageId.EBR_050, Severity.ERROR);
    severities.put(MessageId.EBR_051, Severity.WARNING);
    severities.put(MessageId.EBR_052, Severity.WARNING);
    severities.put(MessageId.EBR_060, Severity.ERROR);
    severities.put(MessageId.EBR_061, Severity.WARNING);
    severities.put(MessageId.EBR_062, Severity.WARNING);
    ...
    severities.put(MessageId.EBR_083, Severity.WARNING);
    severities.put(MessageId.EBR_084, Severity.ERROR);
    severities.put(MessageId.EBR_085, Severity.ERROR);
    severities.put(MessageId.EBR_086, Severity.ERROR);
